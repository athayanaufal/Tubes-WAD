...
class JanjiTemuController extends Controller
{
    ...
    {
        $janjiTemus = JanjiTemu::with('dokter')->get(); // Pastikan relasi 'dokter' ada di model
        return view('janji_temu', compact('janjiTemus')); // Gunakan nama file view tanpa ekstensi
    }    
