    ...
    <div class="container">
        <div class="register-container">
            ...
            <div class="text-center mb-4">
                <img src="logo-kemenkes.png" alt="Kemenkes Logo" style="width: 100px;">
            </div>
            <!-- Title -->
            ...
            <form action="/register" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="confirm-password" name="confirm_password" placeholder="Masukkan ulang kata sandi" required>
                </div>
